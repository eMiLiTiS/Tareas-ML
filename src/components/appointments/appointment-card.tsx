      ...
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="flex items-start gap-3 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="mt-3 grid gap-1 rounded-xl bg-stone-50 px-3 py-2 text-[11px] text-stone-500">
              <p>
          ...
          <div className="flex flex-col gap-1 flex-shrink-0">
            {onEdit && (
              <button
                ...
                className="inline-flex items-center justify-center gap-1 rounded-lg border border-stone-200 bg-stone-50 px-2.5 py-1 text-xs font-medium text-stone-600 transition-colors hover:bg-stone-100"
              >
                <Edit2 size={12} />
                Editar
              </button>
            ...
            <button
              ...
              className="px-2.5 py-1 rounded-lg text-xs font-medium text-emerald-600 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 transition-colors"
            >
              Realizada
            </button>
            )}
            ...
            <button
              ...
              className="px-2.5 py-1 rounded-lg text-xs font-medium text-rose-600 bg-rose-50 hover:bg-rose-100 border border-rose-200 transition-colors"
            >
              Cancelar
            </button>
            )}
          ...
          <div className="flex flex-col gap-1 flex-shrink-0">
            ...
            {onUpdateStatus && (
              <button
                ...
                className="px-2.5 py-1 rounded-lg text-xs font-medium text-stone-600 bg-stone-50 hover:bg-stone-100 border border-stone-200 transition-colors"
              >
                Restablecer
              </button>
            )}
